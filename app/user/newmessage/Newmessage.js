      ...
      <div className="max-w-[1080px] w-full px-5 2xl:px-0 md:pb-[115px] pb-[104px] leading-[130%]">
        ...
        <div className="border dark:border-[#545460] p-5 mt-2 rounded-xl">
          ...
          <div className="mt-6 flex justify-end gap-2  p-4 ">
            <div className="">
              <span className="text-[#070707] dark:text-gray-300 font-medium">
                Payment Options:
              </span>
              <div className="flex gap-2 mt-2">
                <img
                  src="/visa-icon-2048x1313-o6hi8q5l.png"
                  alt="Visa"
                  className="h-6"
                />
                <img
                  src="/mastercard-icon-2048x1286-s6y46dfh.png"
                  alt="Mastercard"
                  className="h-6"
                />
                <img src="/images.jpg" alt="Discover" className="h-6" />
                <img
                  src="/image_processing20250206-349039-19g3b5c.gif"
                  alt="Stripe"
                  className="h-6"
                />
                <img
                  src="/paypal-app-icon-payment-platform-paypal-app-icon-payment-platform-vector-illustration-financial-application-307045425.webp"
                  alt="PayPal"
                  className="h-6"
                />
