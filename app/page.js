...
export default function Home() {
  ...
  return (
    <div className="mt-44 max-w-[1080px] mx-auto px-4 lg:px-0">
      {/* about section  */}
      <div className="border rounded-lg">
        <div className="flex justify-between items-center bg-[#f7f9ff] px-16 py-5 dark:bg-[#1a1a1a]">
          <h1 className="text-[2rem] font-semibold">Wade Warren</h1>
          <span className="flex">
            <SiComma size={20} />
            <SiComma size={20} />
          </span>
      ...
      <h1 className="text-[2.7rem] font-medium mt-16 lg:mt-28">
      ...
      <div className="border rounded-lg p-6 mt-8">
        ...
        <div className="flex flex-col lg:flex-row justify-between gap-4">
          ...
          <Button className="w-full py-6 hover:bg-gray-200 rounded-full bg-[#eff3fe] text-black dark:bg-[#1a1a1a] dark:text-white text-[18px]">
            Pay & Submit Message
          </Button>
        </div>
        ...
        <div className="flex justify-end mt-4">
          <Image src={visa} alt="payment" className="rounded-md mx-1 h-6 w-9" />
          <Image
            src={stripe}
            alt="payment"
      ...
      {/* leader board  */}
      <h1 className="text-[2.7rem] font-medium mt-16 lg:mt-28 mb-8">
        LeaderBoard
      </h1>
      ...
      <p className="text-[1rem] mt-9 text-[#393C44] dark:text-white">
      ...
      <p className="text-[1rem] mt-4 text-[#393C44] dark:text-white">
        Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod
        tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim
        veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea
        commodo consequat. Duis aute irure dolor in reprehenderit in voluptate
      ...
      {/* contact us  */}
      <h1 className="text-[2.7rem] font-medium mt-16 lg:mt-28">Contact Us</h1>
