        ...
        <DialogContent className=" text-lg p-6  pt-[80px] pb-[70px] rounded-lg  md:max-w-[528px] max-w-[90%] ">
          <div className="flex ">
            <div className="flex flex-col items-center justify-center md:w-full max-w-[80%] overflow-hidden">
              ...
              <p
                className="text-[#393C44] dark:text-[#C9CCD8] leading-[160%] text-center text-base  font-medium"
                style={{ maxWidth: "34ch" }}
              >
              ...
              <div className="flex gap-4 justify-center flex-row items-center mt-6">
                <button className="bg-[#070707]  dark:bg-[#F3F6FE] dark:text-[#070707] text-white px-[32px] py-4 rounded-[99px] border-[#070707] text-base font-medium">
                  Register Now
                </button>
                <button>
                  <a
                    href=""
                    className="text-[#4A4C56] font-normal border-[#4A4C56] border-b dark:text-[#D1D7E5] dark:border-[#D1D7E5] "
                  >
                    Maybe Later
                  </a>
                </button>
