    ...
    <div>
      ...
      >
        ...
        <span className="text-gray-400">
          {message ? `Contact Us Info` : "No Message Management"}{" "}
        </span>{" "}
        {message ? `/ Issue/Message Details` : `/ Edit Message`}
      </div>
      <div className="bg-white p-6 rounded-lg mt-5">
        ...
        {message ? (
          <div className="border border-[#D2D2D5] p-6 rounded-[8px] mt-6">
            <p className="md:text-lg text-base font-semibold leading-[170%] tracking-[0.135px] text-[#030304]">
              Subject :{" "}
